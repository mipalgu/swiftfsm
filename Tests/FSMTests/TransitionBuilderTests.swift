...
final class TransitionBuilderTests: XCTestCase {
    ...
    func testOneTransitions() {
        @TransitionBuilder
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            CallbackTransition<EmptyState, Int>(target: 0) { state in
        ...
        @TransitionBuilder
        var falseTransitions: [AnyTransition<EmptyState, Int>] {
            CallbackTransition<EmptyState, Int>(target: 0) { state in
                self.calls.calls.append(state.name)
                XCTAssertEqual(state.name, "0")
                return false
    ...
    func testTwoTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 1) { state in
                self.calls.calls.append(state.name)
    ...
    func testThreeTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 2) { state in
                self.calls.calls.append(state.name)
    ...
    func testFourTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 3) { state in
                self.calls.calls.append(state.name)
    ...
    func testFiveTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 4) { state in
                self.calls.calls.append(state.name)
    ...
    func testSixTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 5) { state in
                self.calls.calls.append(state.name)
    ...
    func testSevenTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 6) { state in
                self.calls.calls.append(state.name)
    ...
    func testEightTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 7) { state in
                self.calls.calls.append(state.name)
    ...
    func testNineTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 8) { state in
                self.calls.calls.append(state.name)
    ...
    func testTenTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 9) { state in
                self.calls.calls.append(state.name)
    ...
    func testElevenTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 10) { state in
                self.calls.calls.append(state.name)
    ...
    func testTwelveTransitions() {
        ...
        var trueTransitions: [AnyTransition<EmptyState, Int>] {
            ...
            CallbackTransition<EmptyState, Int>(target: 11) { state in
                self.calls.calls.append(state.name)
    ...
    private func checkTransitions(
        transitions: [AnyTransition<EmptyState, Int>],
        calls: Calls,
        expectedValue: Bool,
        expectedCount: Int
    ) {
        ...
        for index in 0..<transitions.count {
            let state = EmptyState(name: "\(index)")
