...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/mipalgu/KripkeStructures", from: "1.3.0"),
    ...
    targets: [
        ...
        .testTarget(
            name: "FSMTestTests",
            dependencies: ["FSM", "InMemoryVariables", "Model", "Mocks", "LLFSMs", "Verification", "FSMTest"]
        ),
        .testTarget(
            name: "LLFSMsTests",
        ...
        .testTarget(
            name: "ModelMacrosTests",
            dependencies: [
                .target(name: "ModelMacros"),
