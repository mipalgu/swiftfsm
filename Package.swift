...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MachineStructure", dependencies: ["Libraries", "GUSimpleWhiteboard", "SwiftMachines", "Timers"]),
        .target(name: "MachineLoading", dependencies: ["GUSimpleWhiteboard", "SwiftMachines", "IO"]),
        .target(name: "MachineCompiling", dependencies: ["SwiftMachines", "IO"]),
